...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/graphics/Bitmap;Landroid/net/Uri;Landroid/os/Bundle;Landroid/net/Uri;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->h:Ljava/lang/String;

    iput-object p2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->i:Ljava/lang/CharSequence;

    iput-object p3, p0, Landroid/support/v4/media/MediaDescriptionCompat;->j:Ljava/lang/CharSequence;

    iput-object p4, p0, Landroid/support/v4/media/MediaDescriptionCompat;->k:Ljava/lang/CharSequence;

    iput-object p5, p0, Landroid/support/v4/media/MediaDescriptionCompat;->l:Landroid/graphics/Bitmap;

    iput-object p6, p0, Landroid/support/v4/media/MediaDescriptionCompat;->m:Landroid/net/Uri;

    iput-object p7, p0, Landroid/support/v4/media/MediaDescriptionCompat;->n:Landroid/os/Bundle;

    iput-object p8, p0, Landroid/support/v4/media/MediaDescriptionCompat;->o:Landroid/net/Uri;
...
.method public static b(Ljava/lang/Object;)Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    iput-object p0, v0, Landroid/support/v4/media/MediaDescriptionCompat;->p:Landroid/media/MediaDescription;
...
.method public c()Ljava/lang/Object;
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->p:Landroid/media/MediaDescription;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->h:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->j:Ljava/lang/CharSequence;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->l:Landroid/graphics/Bitmap;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaDescriptionCompat;->o:Landroid/net/Uri;

    if-eqz v3, :cond_4f

    iget-object v3, p0, Landroid/support/v4/media/MediaDescriptionCompat;->n:Landroid/os/Bundle;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaDescriptionCompat;->n:Landroid/os/Bundle;

    invoke-direct {v3, v4}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    :goto_47
    iget-object v4, p0, Landroid/support/v4/media/MediaDescriptionCompat;->o:Landroid/net/Uri;
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->o:Landroid/net/Uri;
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->p:Landroid/media/MediaDescription;
