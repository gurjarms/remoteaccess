...
.method public onReceiveResult(ILandroid/os/Bundle;)V
    ...
    iget-object p1, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver;->h:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {p2, v2}, Lv/k;->a(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v2

    invoke-static {v2}, Landroid/support/v4/media/session/b$a;->o(Landroid/os/IBinder;)Landroid/support/v4/media/session/b;
    ...
    invoke-static {p2, v2}, Lt3/a;->b(Landroid/os/Bundle;Ljava/lang/String;)Lt3/d;

    move-result-object p2

    invoke-virtual {v1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->d(Lt3/d;)V
