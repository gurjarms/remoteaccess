...
# instance fields
.field public final h:Landroid/support/v4/media/MediaDescriptionCompat;

.field public final i:J

.field public j:Landroid/media/session/MediaSession$QueueItem;
...
.method public constructor <init>(Landroid/media/session/MediaSession$QueueItem;Landroid/support/v4/media/MediaDescriptionCompat;J)V
    ...
    iput-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->h:Landroid/support/v4/media/MediaDescriptionCompat;

    iput-wide p3, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->i:J

    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->j:Landroid/media/session/MediaSession$QueueItem;
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->h:Landroid/support/v4/media/MediaDescriptionCompat;

    invoke-virtual {p1}, Landroid/os/Parcel;->readLong()J

    move-result-wide v0

    iput-wide v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->i:J
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->h:Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    iget-wide v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->i:J
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->h:Landroid/support/v4/media/MediaDescriptionCompat;

    invoke-virtual {v0, p1, p2}, Landroid/support/v4/media/MediaDescriptionCompat;->writeToParcel(Landroid/os/Parcel;I)V

    iget-wide v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->i:J
