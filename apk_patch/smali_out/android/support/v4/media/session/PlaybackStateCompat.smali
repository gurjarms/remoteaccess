...
.method public constructor <init>(IJJFJILjava/lang/CharSequence;JLjava/util/List;JLandroid/os/Bundle;)V
    ...
    iput v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->k:F
    ...
    iput-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->n:Ljava/lang/CharSequence;
    ...
    iput-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->p:Ljava/util/List;
    ...
    iput-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->r:Landroid/os/Bundle;
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->h:I
    ...
    iput v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->k:F
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->n:Ljava/lang/CharSequence;
...
.method public static b(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    iput-object v1, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->s:Landroid/media/session/PlaybackState;
...
.method public toString()Ljava/lang/String;
    ...
    iget v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->k:F
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->n:Ljava/lang/CharSequence;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->h:I
    ...
    iget v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->k:F
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->n:Ljava/lang/CharSequence;
    ...
    iget p2, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->m:I
