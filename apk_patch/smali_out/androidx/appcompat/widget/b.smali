...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v1, p0, Landroidx/appcompat/widget/b;->i:I

    const/4 v2, 0x0

    iput v2, p0, Landroidx/appcompat/widget/b;->j:I

    const v3, 0x800033

    iput v3, p0, Landroidx/appcompat/widget/b;->l:I

    sget-object v6, Lg/j;->a1:[I

    invoke-static {p1, p2, v6, p3, v2}, Ln/h2;->u(Landroid/content/Context;Landroid/util/AttributeSet;[III)Ln/h2;

    move-result-object v3

    invoke-virtual {v3}, Ln/h2;->q()Landroid/content/res/TypedArray;
    ...
    invoke-static/range {v4 .. v10}, Lg0/q0;->J(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    sget p1, Lg/j;->c1:I

    invoke-virtual {v3, p1, v1}, Ln/h2;->j(II)I
    ...
    invoke-virtual {v3, p1, v0}, Ln/h2;->a(IZ)Z
    ...
    invoke-virtual {v3, p1, p2}, Ln/h2;->h(IF)F

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/b;->n:F
    ...
    invoke-virtual {v3, p1, v2}, Ln/h2;->a(IZ)Z
    ...
    invoke-virtual {v3, p1}, Ln/h2;->f(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v3, p1, v2}, Ln/h2;->j(II)I
    ...
    invoke-virtual {v3, p1, v2}, Ln/h2;->e(II)I

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/b;->v:I

    invoke-virtual {v3}, Ln/h2;->v()V
...
.method public c(Landroid/graphics/Canvas;)V
    ...
    invoke-static {p0}, Ln/o2;->b(Landroid/view/View;)Z
    ...
    invoke-virtual {p0, v2}, Landroidx/appcompat/widget/b;->o(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v2}, Landroidx/appcompat/widget/b;->p(I)Z
    ...
    iget v4, p0, Landroidx/appcompat/widget/b;->s:I

    sub-int/2addr v3, v4

    :goto_39
    invoke-virtual {p0, p1, v3}, Landroidx/appcompat/widget/b;->f(Landroid/graphics/Canvas;I)V
    ...
    :cond_3f
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/b;->p(I)Z
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/b;->o(I)Landroid/view/View;
...
.method public d(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/b;->o(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/b;->p(I)Z
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/appcompat/widget/b;->e(Landroid/graphics/Canvas;I)V
...
.method public e(Landroid/graphics/Canvas;I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/b;->r:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/b;->r:Landroid/graphics/drawable/Drawable;
...
.method public f(Landroid/graphics/Canvas;I)V
    ...
    iget v2, p0, Landroidx/appcompat/widget/b;->s:I
    ...
    iget v4, p0, Landroidx/appcompat/widget/b;->v:I
...
.method public bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/b;->i()Landroidx/appcompat/widget/b$a;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/b;->j(Landroid/util/AttributeSet;)Landroidx/appcompat/widget/b$a;
...
.method public bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/b;->k(Landroid/view/ViewGroup$LayoutParams;)Landroidx/appcompat/widget/b$a;
...
.method public getBaseline()I
    ...
    iget v0, p0, Landroidx/appcompat/widget/b;->i:I
    ...
    iget v3, p0, Landroidx/appcompat/widget/b;->k:I

    const/4 v4, 0x1

    if-ne v3, v4, :cond_6c

    iget v3, p0, Landroidx/appcompat/widget/b;->l:I
...
.method public getWeightSum()F
    ...
    iget v0, p0, Landroidx/appcompat/widget/b;->n:F
...
.method public i()Landroidx/appcompat/widget/b$a;
    .registers 4
...
.method public j(Landroid/util/AttributeSet;)Landroidx/appcompat/widget/b$a;
    .registers 4
...
.method public k(Landroid/view/ViewGroup$LayoutParams;)Landroidx/appcompat/widget/b$a;
    .registers 3
...
.method public onLayout(ZIIII)V
    ...
    iget p1, p0, Landroidx/appcompat/widget/b;->k:I
    ...
    :cond_9
    invoke-virtual {p0, p2, p3, p4, p5}, Landroidx/appcompat/widget/b;->q(IIII)V
...
.method public onMeasure(II)V
    ...
    :cond_9
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/b;->t(II)V
...
.method public p(I)Z
    ...
    iget p1, p0, Landroidx/appcompat/widget/b;->u:I
...
.method public q(IIII)V
    ...
    invoke-static/range {p0 .. p0}, Ln/o2;->b(Landroid/view/View;)Z
    ...
    iget v1, v6, Landroidx/appcompat/widget/b;->l:I
    ...
    iget-boolean v12, v6, Landroidx/appcompat/widget/b;->h:Z

    iget-object v13, v6, Landroidx/appcompat/widget/b;->p:[I

    iget-object v14, v6, Landroidx/appcompat/widget/b;->q:[I

    invoke-static/range {p0 .. p0}, Lg0/q0;->p(Landroid/view/View;)I

    move-result v1

    invoke-static {v2, v1}, Lg0/i;->a(II)I
    ...
    invoke-virtual {v6, v2}, Landroidx/appcompat/widget/b;->o(I)Landroid/view/View;

    move-result-object v0

    if-nez v0, :cond_78

    invoke-virtual {v6, v2}, Landroidx/appcompat/widget/b;->u(I)I
    ...
    :goto_f1
    invoke-virtual {v6, v2}, Landroidx/appcompat/widget/b;->p(I)Z

    move-result v10

    if-eqz v10, :cond_fa

    iget v10, v6, Landroidx/appcompat/widget/b;->s:I
    ...
    invoke-virtual {v6, v0}, Landroidx/appcompat/widget/b;->m(Landroid/view/View;)I
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/appcompat/widget/b;->w(Landroid/view/View;IIII)V
    ...
    invoke-virtual {v6, v0, v11}, Landroidx/appcompat/widget/b;->l(Landroid/view/View;I)I
...
.method public r(IIII)V
    ...
    iget v0, v6, Landroidx/appcompat/widget/b;->l:I
    ...
    invoke-virtual {v6, v12}, Landroidx/appcompat/widget/b;->o(I)Landroid/view/View;
    ...
    invoke-virtual {v6, v12}, Landroidx/appcompat/widget/b;->u(I)I
    ...
    invoke-static {v1, v2}, Lg0/i;->a(II)I
    ...
    invoke-virtual {v6, v12}, Landroidx/appcompat/widget/b;->p(I)Z
    ...
    invoke-virtual {v6, v13}, Landroidx/appcompat/widget/b;->m(Landroid/view/View;)I
    ...
    invoke-virtual {v6, v13, v12}, Landroidx/appcompat/widget/b;->l(Landroid/view/View;I)I
...
.method public setDividerDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_5
    iput-object p1, p0, Landroidx/appcompat/widget/b;->r:Landroid/graphics/drawable/Drawable;
    ...
    iput v1, p0, Landroidx/appcompat/widget/b;->s:I
    ...
    :cond_17
    iput v0, p0, Landroidx/appcompat/widget/b;->s:I
...
.method public t(II)V
    ...
    iput v10, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    iget-object v0, v7, Landroidx/appcompat/widget/b;->p:[I

    const/4 v14, 0x4

    if-eqz v0, :cond_1e

    iget-object v0, v7, Landroidx/appcompat/widget/b;->q:[I
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/b;->p:[I

    new-array v0, v14, [I

    iput-object v0, v7, Landroidx/appcompat/widget/b;->q:[I

    :cond_26
    iget-object v15, v7, Landroidx/appcompat/widget/b;->p:[I

    iget-object v6, v7, Landroidx/appcompat/widget/b;->q:[I
    ...
    iget-boolean v4, v7, Landroidx/appcompat/widget/b;->h:Z

    iget-boolean v3, v7, Landroidx/appcompat/widget/b;->o:Z
    ...
    invoke-virtual {v7, v1}, Landroidx/appcompat/widget/b;->o(I)Landroid/view/View;

    move-result-object v6

    if-nez v6, :cond_7f

    iget v5, v7, Landroidx/appcompat/widget/b;->m:I

    invoke-virtual {v7, v1}, Landroidx/appcompat/widget/b;->u(I)I

    move-result v6

    add-int/2addr v5, v6

    iput v5, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    invoke-virtual {v7, v6, v1}, Landroidx/appcompat/widget/b;->l(Landroid/view/View;I)I
    ...
    :cond_8b
    invoke-virtual {v7, v1}, Landroidx/appcompat/widget/b;->p(I)Z
    ...
    iget v10, v7, Landroidx/appcompat/widget/b;->s:I
    ...
    iget v0, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    :goto_c2
    iput v0, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    invoke-virtual/range {v0 .. v6}, Landroidx/appcompat/widget/b;->s(Landroid/view/View;IIIII)V
    ...
    iget v1, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    invoke-virtual {v7, v3}, Landroidx/appcompat/widget/b;->n(Landroid/view/View;)I
    ...
    :goto_158
    iput v1, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    iget v6, v7, Landroidx/appcompat/widget/b;->l:I
    ...
    invoke-virtual {v7, v3, v10}, Landroidx/appcompat/widget/b;->l(Landroid/view/View;I)I
    ...
    iget v3, v7, Landroidx/appcompat/widget/b;->m:I

    if-lez v3, :cond_21a

    invoke-virtual {v7, v11}, Landroidx/appcompat/widget/b;->p(I)Z
    ...
    iget v1, v7, Landroidx/appcompat/widget/b;->s:I

    add-int/2addr v3, v1

    iput v3, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    iput v2, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    invoke-virtual {v7, v2}, Landroidx/appcompat/widget/b;->o(I)Landroid/view/View;
    ...
    invoke-virtual {v7, v2}, Landroidx/appcompat/widget/b;->u(I)I
    ...
    invoke-virtual {v7, v3, v2}, Landroidx/appcompat/widget/b;->l(Landroid/view/View;I)I
    ...
    iget v6, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    iput v6, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    invoke-virtual {v7, v10}, Landroidx/appcompat/widget/b;->o(I)Landroid/view/View;
    ...
    :cond_333
    :goto_333
    iget v5, v7, Landroidx/appcompat/widget/b;->n:F
    ...
    :goto_3cb
    iget v8, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    invoke-virtual {v7, v14}, Landroidx/appcompat/widget/b;->n(Landroid/view/View;)I
    ...
    iput v8, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    iget v5, v7, Landroidx/appcompat/widget/b;->l:I
    ...
    invoke-virtual {v7, v1, v0}, Landroidx/appcompat/widget/b;->g(II)V
...
.method public v(II)V
    ...
    iget v14, v7, Landroidx/appcompat/widget/b;->i:I

    iget-boolean v15, v7, Landroidx/appcompat/widget/b;->o:Z
    ...
    invoke-virtual {v7, v6}, Landroidx/appcompat/widget/b;->o(I)Landroid/view/View;
    ...
    invoke-virtual {v7, v6}, Landroidx/appcompat/widget/b;->u(I)I

    move-result v10

    add-int/2addr v4, v10

    iput v4, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    invoke-virtual {v7, v4, v6}, Landroidx/appcompat/widget/b;->l(Landroid/view/View;I)I
    ...
    :cond_5e
    invoke-virtual {v7, v6}, Landroidx/appcompat/widget/b;->p(I)Z
    ...
    iput v1, v7, Landroidx/appcompat/widget/b;->j:I
    ...
    :goto_17c
    invoke-virtual {v7, v3, v11}, Landroidx/appcompat/widget/b;->l(Landroid/view/View;I)I
    ...
    iget v2, v7, Landroidx/appcompat/widget/b;->m:I

    if-lez v2, :cond_1b5

    move/from16 v2, v26

    invoke-virtual {v7, v2}, Landroidx/appcompat/widget/b;->p(I)Z
    ...
    invoke-virtual {v7, v4}, Landroidx/appcompat/widget/b;->o(I)Landroid/view/View;
    ...
    invoke-virtual {v7, v4}, Landroidx/appcompat/widget/b;->u(I)I
    ...
    invoke-virtual {v7, v6, v4}, Landroidx/appcompat/widget/b;->l(Landroid/view/View;I)I
    ...
    iget v14, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    invoke-virtual {v7, v6}, Landroidx/appcompat/widget/b;->n(Landroid/view/View;)I
    ...
    iget v11, v7, Landroidx/appcompat/widget/b;->m:I
    ...
    :cond_274
    :goto_274
    iget v10, v7, Landroidx/appcompat/widget/b;->n:F
    ...
    invoke-virtual {v7, v8}, Landroidx/appcompat/widget/b;->o(I)Landroid/view/View;
    ...
    invoke-virtual {v7, v13}, Landroidx/appcompat/widget/b;->n(Landroid/view/View;)I
    ...
    invoke-virtual {v7, v2, v6}, Landroidx/appcompat/widget/b;->h(II)V
