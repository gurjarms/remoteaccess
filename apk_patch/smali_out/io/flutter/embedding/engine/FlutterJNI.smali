...
.field private deferredComponentManager:Le6/a;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, p1, p2}, Lc6/d;-><init>(J)V
    ...
    invoke-static {p1, p2, p0}, La6/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Ld6/f;

    if-eqz v0, :cond_7

    invoke-interface {v0, p1, p2}, Ld6/f;->f(ILjava/nio/ByteBuffer;)V
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lq6/b;
    ...
    :cond_47
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lq6/b;

    invoke-virtual {p1, v0}, Lq6/b;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, La6/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/f$g;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, Lp6/r;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_12
    iget p2, p2, Lio/flutter/view/f$g;->h:I
...
.method public getScaledFontSize(FI)F
    ...
    invoke-static {p2}, Lo6/p;->b(I)Landroid/util/DisplayMetrics;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Ld6/f;->h(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public requestDartDeferredLibrary(I)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Le6/a;

    if-eqz v0, :cond_9

    const/4 v1, 0x0

    invoke-interface {v0, p1, v1}, Le6/a;->b(ILjava/lang/String;)V
...
.method public setDeferredComponentManager(Le6/a;)V
    .registers 2

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Le6/a;

    if-eqz p1, :cond_a

    invoke-interface {p1, p0}, Le6/a;->e(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_a
    return-void
.end method

.method public setLocalizationPlugin(Lq6/b;)V
    .registers 2

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lq6/b;

    return-void
.end method

.method public setPlatformMessageHandler(Ld6/f;)V
    .registers 2

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Ld6/f;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Ly6/d;->a(ZLjava/lang/Object;)V
