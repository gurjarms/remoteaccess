...
.method public constructor <init>(Landroid/content/Context;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lf6/d;->n(Landroid/content/Context;)V

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    invoke-virtual {v0, p1, p2}, Lf6/d;->f(Landroid/content/Context;[Ljava/lang/String;)V
...
.method public a(Lio/flutter/embedding/engine/b$b;)Lio/flutter/embedding/engine/a;
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/b$b;->c()Ld6/a$b;
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/b$b;->f()Lio/flutter/plugin/platform/x;
    ...
    invoke-static {}, Ld6/a$b;->a()Ld6/a$b;
    ...
    invoke-virtual {p0, v1, v5, v6, v7}, Lio/flutter/embedding/engine/b;->b(Landroid/content/Context;Lio/flutter/plugin/platform/x;ZZ)Lio/flutter/embedding/engine/a;

    move-result-object p1

    if-eqz v3, :cond_43

    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->o()Lo6/j;

    move-result-object v0

    invoke-virtual {v0, v3}, Lo6/j;->c(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2, v4}, Ld6/a;->j(Ld6/a$b;Ljava/util/List;)V
    ...
    invoke-virtual/range {v0 .. v7}, Lio/flutter/embedding/engine/a;->A(Landroid/content/Context;Ld6/a$b;Ljava/lang/String;Ljava/util/List;Lio/flutter/plugin/platform/x;ZZ)Lio/flutter/embedding/engine/a;
...
.method public b(Landroid/content/Context;Lio/flutter/plugin/platform/x;ZZ)Lio/flutter/embedding/engine/a;
    .registers 15
