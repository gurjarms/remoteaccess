...
.field public s:Landroid/view/inputmethod/BaseInputConnection;


# direct methods
.method public constructor <init>(Lo6/s$e;Landroid/view/View;)V
    .registers 5
    ...
    iput v0, p0, Lio/flutter/plugin/editing/e;->h:I
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/e;->j:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lio/flutter/plugin/editing/e;->k:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lio/flutter/plugin/editing/e;->l:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/e;->s:Landroid/view/inputmethod/BaseInputConnection;

    if-eqz p1, :cond_2a

    invoke-virtual {p0, p1}, Lio/flutter/plugin/editing/e;->n(Lo6/s$e;)V
...
.method public a(Lio/flutter/plugin/editing/e$b;)V
    ...
    iget v0, p0, Lio/flutter/plugin/editing/e;->i:I
    ...
    :cond_23
    iget v0, p0, Lio/flutter/plugin/editing/e;->h:I
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/e;->k:Ljava/util/ArrayList;

    goto :goto_31

    :cond_2f
    iget-object v0, p0, Lio/flutter/plugin/editing/e;->j:Ljava/util/ArrayList;
...
.method public b()V
    ...
    invoke-static {v0, v2}, La6/b;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/e;->n:Ljava/lang/String;
    ...
    iput v0, p0, Lio/flutter/plugin/editing/e;->r:I
...
.method public c()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/e;->l:Ljava/util/ArrayList;
...
.method public d()V
    ...
    invoke-virtual {p0, v3, v2, v2, v2}, Lio/flutter/plugin/editing/e;->j(Lio/flutter/plugin/editing/e$b;ZZZ)V
    ...
    iget-object v3, p0, Lio/flutter/plugin/editing/e;->j:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lio/flutter/plugin/editing/e;->n:Ljava/lang/String;
    ...
    iget v1, p0, Lio/flutter/plugin/editing/e;->p:I
    ...
    iget v3, p0, Lio/flutter/plugin/editing/e;->r:I
    ...
    :cond_81
    invoke-virtual {p0, v0, v1, v4}, Lio/flutter/plugin/editing/e;->k(ZZZ)V

    :cond_84
    iget-object v0, p0, Lio/flutter/plugin/editing/e;->j:Ljava/util/ArrayList;

    iget-object v1, p0, Lio/flutter/plugin/editing/e;->k:Ljava/util/ArrayList;
...
.method public e()Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lio/flutter/plugin/editing/e;->l:Ljava/util/ArrayList;
...
.method public final j(Lio/flutter/plugin/editing/e$b;ZZZ)V
    .registers 6
    ...
    iget p1, p0, Lio/flutter/plugin/editing/e;->i:I

    add-int/lit8 p1, p1, -0x1

    iput p1, p0, Lio/flutter/plugin/editing/e;->i:I
...
.method public final k(ZZZ)V
    ...
    invoke-virtual {p0, v1, p1, p2, p3}, Lio/flutter/plugin/editing/e;->j(Lio/flutter/plugin/editing/e$b;ZZZ)V
...
.method public m(II)V
    ...
    :cond_5
    iget-object v0, p0, Lio/flutter/plugin/editing/e;->s:Landroid/view/inputmethod/BaseInputConnection;
...
.method public n(Lo6/s$e;)V
    ...
    iget-object v1, p1, Lo6/s$e;->a:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lo6/s$e;->c()Z

    move-result v0

    if-eqz v0, :cond_1b

    iget v0, p1, Lo6/s$e;->b:I

    iget v1, p1, Lo6/s$e;->c:I
    ...
    :goto_1e
    iget v0, p1, Lo6/s$e;->d:I

    iget p1, p1, Lo6/s$e;->e:I
...
.method public replace(IILjava/lang/CharSequence;II)Landroid/text/SpannableStringBuilder;
    ...
    iget v1, v0, Lio/flutter/plugin/editing/e;->i:I
    ...
    iput-object v1, v0, Lio/flutter/plugin/editing/e;->m:Ljava/lang/String;
    ...
    iget-object v8, v0, Lio/flutter/plugin/editing/e;->l:Ljava/util/ArrayList;
    ...
    iget v1, v0, Lio/flutter/plugin/editing/e;->h:I
    ...
    :goto_a9
    invoke-virtual {v0, v12, v1, v10}, Lio/flutter/plugin/editing/e;->k(ZZZ)V
...
.method public setSpan(Ljava/lang/Object;III)V
    ...
    iget-object p1, p0, Lio/flutter/plugin/editing/e;->l:Ljava/util/ArrayList;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/e;->m:Ljava/lang/String;
