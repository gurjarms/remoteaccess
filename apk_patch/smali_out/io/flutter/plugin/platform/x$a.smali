...
.method public static synthetic j(Lio/flutter/plugin/platform/x$a;Lio/flutter/plugin/platform/h0;FLo6/m$b;)V
    .registers 4

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/x$a;->k(Lio/flutter/plugin/platform/h0;FLo6/m$b;)V

    return-void
.end method

.method private synthetic k(Lio/flutter/plugin/platform/h0;FLo6/m$b;)V
    .registers 9
    ...
    invoke-direct {v0, v1, p1}, Lo6/m$c;-><init>(II)V

    invoke-interface {p3, v0}, Lo6/m$b;->a(Lo6/m$c;)V
...
.method public b(II)V
    ...
    invoke-virtual {v0, p1}, Lio/flutter/plugin/platform/x;->c(I)Z
...
.method public c(Lo6/m$d;)V
    ...
    invoke-static {v0, p1}, Lio/flutter/plugin/platform/x;->j(Lio/flutter/plugin/platform/x;Lo6/m$d;)V

    iget-object v0, p0, Lio/flutter/plugin/platform/x$a;->a:Lio/flutter/plugin/platform/x;

    const/4 v1, 0x0

    invoke-virtual {v0, p1, v1}, Lio/flutter/plugin/platform/x;->M(Lo6/m$d;Z)Lio/flutter/plugin/platform/j;

    move-result-object v0

    iget-object v1, p0, Lio/flutter/plugin/platform/x$a;->a:Lio/flutter/plugin/platform/x;

    invoke-static {v1, v0, p1}, Lio/flutter/plugin/platform/x;->u(Lio/flutter/plugin/platform/x;Lio/flutter/plugin/platform/j;Lo6/m$d;)V

    return-void
.end method

.method public d(Lo6/m$e;Lo6/m$b;)V
    .registers 7

    iget-object v0, p0, Lio/flutter/plugin/platform/x$a;->a:Lio/flutter/plugin/platform/x;

    iget-wide v1, p1, Lo6/m$e;->b:D
    ...
    iget-wide v2, p1, Lo6/m$e;->c:D

    invoke-static {v1, v2, v3}, Lio/flutter/plugin/platform/x;->l(Lio/flutter/plugin/platform/x;D)I

    move-result v1

    iget p1, p1, Lo6/m$e;->a:I

    iget-object v2, p0, Lio/flutter/plugin/platform/x$a;->a:Lio/flutter/plugin/platform/x;

    invoke-virtual {v2, p1}, Lio/flutter/plugin/platform/x;->c(I)Z
    ...
    invoke-direct {v3, p0, p1, v2, p2}, Lio/flutter/plugin/platform/w;-><init>(Lio/flutter/plugin/platform/x$a;Lio/flutter/plugin/platform/h0;FLo6/m$b;)V
    ...
    invoke-interface {v2}, Lio/flutter/plugin/platform/j;->e()Landroid/view/View;
    ...
    invoke-direct {p1, v0, v1}, Lo6/m$c;-><init>(II)V

    invoke-interface {p2, p1}, Lo6/m$b;->a(Lo6/m$c;)V
...
.method public f(Lo6/m$f;)V
    .registers 6

    iget v0, p1, Lo6/m$f;->a:I
    ...
    invoke-virtual {v2, v0}, Lio/flutter/plugin/platform/x;->c(I)Z
    ...
    invoke-virtual {v2, v1, p1, v3}, Lio/flutter/plugin/platform/x;->x0(FLo6/m$f;Z)Landroid/view/MotionEvent;
    ...
    invoke-virtual {v0, v1, p1, v3}, Lio/flutter/plugin/platform/x;->x0(FLo6/m$f;Z)Landroid/view/MotionEvent;
...
.method public i(Lo6/m$d;)J
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/x;->x(Lio/flutter/plugin/platform/x;)Lb6/t;
    ...
    invoke-static {v2, v3}, Ly6/i;->f(Landroid/view/View;[Ljava/lang/Class;)Z
    ...
    iget-object v1, p1, Lo6/m$d;->h:Lo6/m$d$a;

    sget-object v2, Lo6/m$d$a;->i:Lo6/m$d$a;
    ...
    invoke-static {v1, v0, p1}, Lio/flutter/plugin/platform/x;->A(Lio/flutter/plugin/platform/x;Lio/flutter/plugin/platform/j;Lo6/m$d;)J
    ...
    invoke-virtual {v1, v0, p1}, Lio/flutter/plugin/platform/x;->I(Lio/flutter/plugin/platform/j;Lo6/m$d;)J
