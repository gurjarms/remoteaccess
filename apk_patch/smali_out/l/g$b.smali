...
.method public g(Landroid/util/AttributeSet;)V
    ...
    invoke-static {v0, p1, v1}, Ln/h2;->t(Landroid/content/Context;Landroid/util/AttributeSet;[I)Ln/h2;
    ...
    invoke-virtual {p1, v0, v1}, Ln/h2;->m(II)I
    ...
    invoke-virtual {p1, v0, v2}, Ln/h2;->j(II)I
    ...
    invoke-virtual {p1, v2, v3}, Ln/h2;->j(II)I
    ...
    invoke-virtual {p1, v0}, Ln/h2;->o(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v0}, Ln/h2;->n(I)Ljava/lang/String;
    ...
    invoke-virtual {p1, v0}, Ln/h2;->r(I)Z

    move-result v2

    if-eqz v2, :cond_7c

    invoke-virtual {p1, v0, v1}, Ln/h2;->a(IZ)Z
    ...
    invoke-virtual {p1, v0, v2}, Ln/h2;->a(IZ)Z
    ...
    iput-object v0, p0, Ll/g$b;->A:Lg0/b;
    ...
    :cond_ed
    iput-object v4, p0, Ll/g$b;->A:Lg0/b;
    ...
    invoke-virtual {p1, v0}, Ln/h2;->c(I)Landroid/content/res/ColorStateList;
...
.method public final i(Landroid/view/MenuItem;)V
    ...
    :cond_97
    :goto_97
    iget-object v0, p0, Ll/g$b;->A:Lg0/b;

    if-eqz v0, :cond_9e

    invoke-static {p1, v0}, Lg0/b0;->a(Landroid/view/MenuItem;Lg0/b;)Landroid/view/MenuItem;

    :cond_9e
    iget-object v0, p0, Ll/g$b;->B:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Lg0/b0;->c(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Ll/g$b;->C:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Lg0/b0;->g(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-char v0, p0, Ll/g$b;->n:C

    iget v1, p0, Ll/g$b;->o:I

    invoke-static {p1, v0, v1}, Lg0/b0;->b(Landroid/view/MenuItem;CI)V

    iget-char v0, p0, Ll/g$b;->p:C

    iget v1, p0, Ll/g$b;->q:I

    invoke-static {p1, v0, v1}, Lg0/b0;->f(Landroid/view/MenuItem;CI)V

    iget-object v0, p0, Ll/g$b;->E:Landroid/graphics/PorterDuff$Mode;

    if-eqz v0, :cond_bd

    invoke-static {p1, v0}, Lg0/b0;->e(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, Lg0/b0;->d(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
