...
# instance fields
.field public final synthetic h:Lo6/s;
...
.method public constructor <init>(Lo6/s;)V
    ...
    iput-object p1, p0, Lo6/s$a;->h:Lo6/s;
...
.method public h(Lp6/j;Lp6/k$d;)V
    ...
    iget-object v4, v1, Lo6/s$a;->h:Lo6/s;

    invoke-static {v4}, Lo6/s;->a(Lo6/s;)Lo6/s$f;
    ...
    :cond_11
    iget-object v4, v0, Lp6/j;->a:Ljava/lang/String;

    iget-object v0, v0, Lp6/j;->b:Ljava/lang/Object;
    ...
    invoke-static {v6, v5}, La6/b;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface/range {p2 .. p2}, Lp6/k$d;->c()V

    goto/16 :goto_1a9

    :pswitch_bd
    iget-object v0, v1, Lo6/s$a;->h:Lo6/s;

    invoke-static {v0}, Lo6/s;->a(Lo6/s;)Lo6/s$f;

    move-result-object v0

    invoke-interface {v0}, Lo6/s$f;->g()V
    ...
    invoke-interface {v0}, Lo6/s$f;->i()V

    goto/16 :goto_148

    :pswitch_d3
    iget-object v3, v1, Lo6/s$a;->h:Lo6/s;

    invoke-static {v3}, Lo6/s;->a(Lo6/s;)Lo6/s$f;
    ...
    invoke-interface {v3, v0}, Lo6/s$f;->h(Z)V
    ...
    invoke-interface/range {v9 .. v14}, Lo6/s$f;->d(DD[D)V

    invoke-interface {v2, v6}, Lp6/k$d;->a(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, v5, v7}, Lo6/s$f;->a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v0}, Lo6/s$f;->b()V
    ...
    invoke-interface {v0}, Lo6/s$f;->j()V
    ...
    iget-object v5, v1, Lo6/s$a;->h:Lo6/s;

    invoke-static {v5}, Lo6/s;->a(Lo6/s;)Lo6/s$f;

    move-result-object v5

    invoke-static {v0}, Lo6/s$b;->a(Lorg/json/JSONObject;)Lo6/s$b;

    move-result-object v0

    invoke-interface {v5, v3, v0}, Lo6/s$f;->f(ILo6/s$b;)V
    ...
    invoke-interface {v2, v4, v0, v6}, Lp6/k$d;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Lo6/s$e;->a(Lorg/json/JSONObject;)Lo6/s$e;

    move-result-object v0

    invoke-interface {v3, v0}, Lo6/s$f;->e(Lo6/s$e;)V
    ...
    invoke-interface {v5, v3, v0}, Lo6/s$f;->c(IZ)V
