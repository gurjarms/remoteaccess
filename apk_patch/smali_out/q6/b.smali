...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lo6/h;)V
    .registers 4
    ...
    iput-object v0, p0, Lq6/b;->c:Lo6/h$b;

    iput-object p1, p0, Lq6/b;->b:Landroid/content/Context;

    iput-object p2, p0, Lq6/b;->a:Lo6/h;

    invoke-virtual {p2, v0}, Lo6/h;->c(Lo6/h$b;)V

    return-void
.end method

.method public static synthetic a(Lq6/b;)Landroid/content/Context;
    .registers 1
...
.method public c(Ljava/util/List;)Ljava/util/Locale;
    ...
    iget-object v1, p0, Lq6/b;->b:Landroid/content/Context;
    ...
    invoke-static {v1}, Lh/f;->a(Landroid/content/res/Configuration;)Landroid/os/LocaleList;
    ...
    :cond_a9
    invoke-static {v0, p1}, Lq6/a;->a(Ljava/util/List;Ljava/util/Collection;)Ljava/util/Locale;
    ...
    iget-object v0, p0, Lq6/b;->b:Landroid/content/Context;
    ...
    invoke-static {v0}, Lh/f;->a(Landroid/content/res/Configuration;)Landroid/os/LocaleList;
...
.method public d(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p1}, Lh/f;->a(Landroid/content/res/Configuration;)Landroid/os/LocaleList;
    ...
    :cond_25
    iget-object p1, p0, Lq6/b;->a:Lo6/h;

    invoke-virtual {p1, v0}, Lo6/h;->b(Ljava/util/List;)V
