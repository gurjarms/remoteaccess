...
.method public static e(Landroid/net/Uri;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lr5/d;->i(Landroid/net/Uri;)Z
    ...
    invoke-static {p0, p1}, Lr5/d;->d(Landroid/net/Uri;Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_5b
    invoke-static {p0}, Lr5/d;->g(Landroid/net/Uri;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v0, p1}, Lr5/d;->h(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_7f
    invoke-static {p0}, Lr5/d;->c(Landroid/net/Uri;)Ljava/lang/String;
...
.method public static h(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v1, v7}, Lr5/d;->b(Ljava/lang/Class;Ljava/lang/Object;)Ljava/lang/String;
    ...
    move-result-object p0
    :try_end_6b
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_6b} :catch_6f
...
.method public static j(Ljava/io/File;Lr5/a$a;)V
    .registers 8
    ...
    :goto_4d
    invoke-virtual {p1, v1}, Lr5/a$a;->b([B)Lr5/a$a;
    :try_end_50
...
.method public static k(Landroid/content/Context;Landroid/net/Uri;Z)Lr5/a;
    .registers 14
    ...
    invoke-static {p1, p0}, Lr5/d;->d(Landroid/net/Uri;Landroid/content/Context;)Ljava/lang/String;
    ...
    :try_end_63
    .catch Ljava/lang/Exception; {:try_start_5e .. :try_end_63} :catch_95
    ...
    :try_end_82
    .catchall {:try_start_63 .. :try_end_82} :catchall_8a
    ...
    throw p0
    :try_end_93
    .catch Ljava/lang/Exception; {:try_start_82 .. :try_end_93} :catch_93
    ...
    :try_end_9a
    .catch Ljava/io/IOException; {:try_start_97 .. :try_end_9a} :catch_b3
    .catch Ljava/lang/NullPointerException; {:try_start_97 .. :try_end_9a} :catch_b3
    ...
    invoke-static {v4, v0}, Lr5/d;->j(Ljava/io/File;Lr5/a$a;)V

    :cond_d4
    invoke-virtual {v0, v3}, Lr5/a$a;->d(Ljava/lang/String;)Lr5/a$a;

    move-result-object p0

    invoke-virtual {p0, v2}, Lr5/a$a;->c(Ljava/lang/String;)Lr5/a$a;

    move-result-object p0

    invoke-virtual {p0, p1}, Lr5/a$a;->f(Landroid/net/Uri;)Lr5/a$a;
    ...
    invoke-virtual {p0, p1, p2}, Lr5/a$a;->e(J)Lr5/a$a;
