...
.method public static b(Landroid/content/Context;Landroid/content/res/Resources;I)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0}, Ly/m;->e(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_8
    :try_start_8
    invoke-static {p0, p1, p2}, Ly/m;->c(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    :cond_12
    :try_start_12
    invoke-static {p0}, Ly/m;->g(Ljava/io/File;)Ljava/nio/ByteBuffer;
...
.method public static c(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    :try_start_4
    invoke-static {p0, p1}, Ly/m;->d(Ljava/io/File;Ljava/io/InputStream;)Z

    move-result p0
    :try_end_8
    .catchall {:try_start_4 .. :try_end_8} :catchall_c

    invoke-static {p1}, Ly/m;->a(Ljava/io/Closeable;)V
...
.method public static d(Ljava/io/File;Ljava/io/InputStream;)Z
    ...
    invoke-static {v3}, Ly/m;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {v2}, Ly/m;->a(Ljava/io/Closeable;)V
...
.method public static h(Landroid/content/Context;[Ld0/i$b;Landroid/os/CancellationSignal;)Ljava/util/Map;
    .registers 8
    ...
    :cond_12
    invoke-virtual {v3}, Ld0/i$b;->d()Landroid/net/Uri;
    ...
    :cond_1d
    invoke-static {p0, p2, v3}, Ly/m;->f(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
